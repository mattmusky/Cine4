...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Arvo|EB+Garamond|Lora" rel="stylesheet">
...
<body>
    ...
    <div class="site-container">
        <div class="title">
            <h1 class="main-title">cine4</h1>
        </div>
<div class="login_form">
        <!-- Login container -->
        <div id="login-container">
            <form>  <!-- EDIT: id action method-->
              <div id="loginFormError" class="errorMessagesTop"></div>
                ...
                <div class="registration-link">
                   <a id="show_register">Don't have an account? Sign Up.</a>
                </div>
            </form>
        </div>
        <!-- end login container -->
            ...
            <form>
              <!--onsubmit SHOULD NOT return the passwordCheck function. rather it should return a function called submit which calls the validate form function-->
                ...
                <div class="login-link">
                   <a id="show_signin">Already have an account? Log in.</a>
                </div>
            </form>
        </div>
        <!-- end login container -->
...
function submitLogin() {
    ...
    function HandleResponse(response) {
        ...
        switch(response) {
          case "pass_corr":
          window.location.replace("matt_boot/home.php");
